...
emp = [
    FullTimeEmployee('F0001','홍길동',30000000 , 200000),
    FullTimeEmployee('F0001','홍길동',45000000 , 200000),
    PartTimeEmployee('F0001','홍길동',75000000 , 200000),
    PartTimeEmployee('F0001','홍길동',25000000 , 200000),
    FullTimeEmployee('F0001','홍길동',31000000 , 200000),
]
